...
| **Trivia question** | From [Open Trivia DB](https://opentdb.com): a multiple-choice question in one of the categories you pick (Animals, Science & nature, Geography and General knowledge by default; one category a day, taking turns), at **Easy**, **Medium**, **Hard** or **Mixed** difficulty. The answer is highlighted only when someone taps **Show the answer**, and **Hide the answer** covers it again. |
