...
Mode, dark schedule, accent colour, backgrounds, text size, density and **Quiet hours (displays)**. See [Appearance](../using/appearance.md) and [Quiet hours](../using/quiet-hours.md).
