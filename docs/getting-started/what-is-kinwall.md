...
| Look and feel | Light, dark or scheduled dark mode, ten color schemes (or follow the seasons), text size and typeface, set per device. | [Appearance](../using/appearance.md) |
