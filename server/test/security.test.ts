...
import { createApp, CSP_DEFAULT } from '../src/app.ts';
...
test('self-host CSP matches web/public/_headers (the Workers one)', () => {
  const headers = readFileSync(path.join(__dirname, '..', '..', 'web', 'public', '_headers'), 'utf8');
